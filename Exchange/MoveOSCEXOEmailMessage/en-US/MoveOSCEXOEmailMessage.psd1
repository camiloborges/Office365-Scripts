...
CannotFindDestFolder = Cannot find destination folder '{0}'.
FoundEmails = Found {0} email messages that match the search criteria. 
FoundDupFolder = Found two or more folders with same display name.
MoveEmailMsg = Moving email message '{0}'.
'@